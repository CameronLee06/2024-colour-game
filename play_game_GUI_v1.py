...
class Play:
    ...
    def __init__(self, how_many):
        ...
        self.play_box.protocol('WM DELETE WINDOW',
        ...
        self.rounds_results_label = Label(self.rounds_frame, text="Rounds",
                                          width=32, bg="#FFF2CC",
                                          font=("Arial", 10),
                                          pady=5)
        ...
        self.game_results_label = Label(self.quest_frame,
                                        text="Game Totals: Users: - \t Computer:",
    ...
    # DON'T USE THIS FUNCTION IN BASE, IT KILLS THE ROOT
    def close_play(self):
        root.destroy()
